...
//               {(page - 1) * ITMS_PER_PAGE + 1}
//             </span>{" "}
//             to{" "}
//             <span className="font-medium">
//               {page * ITMS_PER_PAGE > totalItems
//                 ? totalItems
//                 : page * ITMS_PER_PAGE}
//             </span>{" "}
...
//             </a>
//             {Array.from({ length: Math.ceil(totalItems / ITMS_PER_PAGE) }).map(
//               (el, index) => (
//                 <div
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          {products?.map((product) => (
            <Link to="/product-detail">
              <div
                key={product.id}
                className="group relative border-solid border-2 p-2 border-gray-200 rounded-lg hover:border-gray-300"
              >
